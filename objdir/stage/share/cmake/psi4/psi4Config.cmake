...
#   psi4_LIBRARY - core.cpython-39-x86_64-linux-gnu.so library to link against.
...
set(${PN}_LIBRARY "${PACKAGE_PREFIX_DIR}/lib//psi4/core.cpython-39-x86_64-linux-gnu.so")
...
psi4_component(ambit ON)
psi4_component(chemps2 ON)
psi4_component(dkh ON)
psi4_component(erd OFF)
psi4_component(gdma ON)
psi4_component(pcmsolver OFF)
psi4_component(cppe OFF)
psi4_component(simint ON)
...
if(NOT CMAKE_REQUIRED_QUIET)
    ...
    message(STATUS "Python executable: /home/jorge/Codes/anaconda3/envs/p4dev/bin/python")
endif()
